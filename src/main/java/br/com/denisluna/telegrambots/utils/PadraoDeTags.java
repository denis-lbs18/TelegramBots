...
public class PadraoDeTags {
	public static final String MESSAGE = "message";

	public static final String FILE_ID = "file_id", WIDTH = "width", HEIGHT = "height", DURATION = "duration",
			MIME_TYPE = "mime_type", FILE_SIZE = "duration", FILE_NAME = "file_name", TITLE = "title";
