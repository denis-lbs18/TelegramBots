...
public class MainPedro implements Runnable {
	public void run() {
        /**
         * Inicia o bot do telegram com o token dado pelo botfather 
         * Para o bot funcionar, alterar a privacidade do bot para DISABLE, enviando o comando /setprivacy para o @botfather 
         */
